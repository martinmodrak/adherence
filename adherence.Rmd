...
Same as above, but excluding furosemide (which we will use for all the other aderence analyses)

```{r}
data_adherent_cat <- data_long %>%
...
```{r}
id_cohort_all_but_one <- data_adherent_cat %>% 
...
Comparison of clinical and laboratory parameters of adherent and non-adherent patients (excluding furosemide, note a single excluded patient who had no drugs measured):

...
```{r}
tbl_summary(data_table1, by = cohort, statistic = tbl1_stats, include = -subject_id)
```
...
Comparison of clinical and laboratory parameters of adherent and non-adherent patients:
...
tbl_summary(data_table_comparison, by = category_bin, statistic = tbl1_stats)
```

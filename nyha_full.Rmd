...
Importantly, despite seeing a large number of patients with VO2 max < 10, only `r n_low_VO2_4` of those patients have subjective NYHA 3-4 or 4. So it is clear that in that region, there is a major discrepancy between the two NYHA assesments.

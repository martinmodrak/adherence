...
tibble(`Objective NYHA` = paste0("NYHA ", 1:4), N = paste0(t_nyha_obj, " (", scales::percent(as.numeric(t_nyha_obj) / nrow(data_nyha), accuracy = 1), ")")) %>% table_format()
...
tibble(`Subjective NYHA` = paste0("NYHA ", names(t_nyha_subj)), N = paste0(t_nyha_subj, " (", scales::percent(as.numeric(t_nyha_subj) / nrow(data_nyha), accuracy = 1), ")")) %>% table_format()
```
